/** @file
 *	@brief MAVLink comm protocol generated from mypx4.xml
...
/** @brief Available commands for controlling the PX4 estimator */
enum class ESTIMATOR_CONTROL_CMD : uint8_t
{
    STOP_DAEMON=0, /*  | */
    START_EKF2=1, /*  | */
    STOP_EKF2=2, /*  | */
...
//! ESTIMATOR_CONTROL_CMD ENUM_END
constexpr auto ESTIMATOR_CONTROL_CMD_ENUM_END = 4;
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_estimator_control_msg.hpp"
